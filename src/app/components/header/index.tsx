  ...
  return (
    ...
    <div className='flex justify-between items-center px-[6.3%] py-[31px] w-full'>
      ...
      <div className='flex items-center gap-[40px]'>
        ...
        <button onClick={() => localStorage.removeItem("selectedFilters")} className='bg-[#8338EC] hover:bg-[#B588F4] transition-[1.3s] cursor-pointer w-[268px] h-[40px] text-white font-firago font-normal text-[16px] rounded-[5px] flex items-center justify-center '><span><FiPlus className='text-[16px] mr-[5xpx]' /></span>შექმენი ახალი დავალება</button>
        </Link>
      </div>
    </div>
